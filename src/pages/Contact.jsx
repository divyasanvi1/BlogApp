...
import Particlebackground from '../components/Particlesbackground'; // Import your ParticleBackground component
...
const ContactUs = () => {
  ...
  return (
    <div className="contact" style={{ position: 'relative',  padding: '40px 0' }}>
      {/* Use the ParticleBackground component */}
      <Particlebackground />
